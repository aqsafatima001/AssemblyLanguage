.data
input_code_point: .word 0x00008A9E # Unicode code point for UTF-8 encoding
.text
.globl main
main:
    lw $a3, input_code_point   # Load the code point into register $a3
    ...
    # Now we have the three UTF-8 bytes in $t0 (E8), $t1 (AA), and $t2 (9E). We need to put them in the correct order in $a2 considering big-endian format
    ...
    # $a2 should now have the value 0x00E8AA9E   # Exit the program  
    li $v0, 10
    syscall
